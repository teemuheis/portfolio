const PROJECTS = [
  {
    ...
    repo: 'https://github.com/teemuheis',
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          {PROJECTS.map((project) => (
            <a
              ...
              className="group rounded-[28px] border border-white/10 bg-gradient-to-b from-white/[0.05] to-transparent p-8 hover:border-orange-500/20 hover:shadow-[0_0_30px_rgba(255,140,0,0.06)] transition-all block"
            >
